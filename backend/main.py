...
app = FastAPI(
    title="AI Powered Sales Intelligence Forecasting — Lead Intelligence & Sales CRM",
    description="Full-stack AI-driven Sales Intelligence & Forecasting Platform powered by NVIDIA NIM & Scikit-Learn",
    version="1.0.0"
)
